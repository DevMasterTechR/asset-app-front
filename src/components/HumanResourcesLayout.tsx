...
const hrNavItems: NavItem[] = [
  { title: 'Mis Asignaciones', href: '/human-resources', icon: PackageSearch },
  { title: 'Solicitudes', href: '/human-resources/requests', icon: FileText },
];

export default function HumanResourcesLayout({ children }: LayoutProps) {
  ...
  const [sidebarCollapsed, setSidebarCollapsed] = useState(() => {
    try {
      const v = localStorage.getItem('sidebar:collapsed:hr');
      return v === 'true';
    } catch (e) {
      return false;
    }
          ...
          {isMobileView && (
            <header className="sticky top-0 z-40 border-b bg-card">
              <div className="flex items-center justify-between p-4">
                <h1 className="font-semibold">Panel Recursos Humanos</h1>
                <Sheet open={isOpen} onOpenChange={setIsOpen}>
                  ...
                  <SheetContent side="left">
                    <SheetTitle>Menú RRHH</SheetTitle>
                    <SheetDescription>Navegación de Recursos Humanos</SheetDescription>
